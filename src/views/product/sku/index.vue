<template>
  <el-card>
    <el-table border style="margin:10px 0px;" :data="skuArr">
      ...
      <el-table-column label="重量" show-overflow-tooltip width="150px" prop="weight"></el-table-column>
      <el-table-column label="价格" show-overflow-tooltip width="150px" prop="price"></el-table-column>
      <el-table-column label="操作" show-overflow-tooltip width="250px" fixed="right">
        <template #="{ row, $index }">
          ...
          <el-popconfirm @confirm="removeSku(row.id)" :title="`你确定要删除${row.skuName}?`" width="200px">
            <template #reference>
    ...
    <el-pagination v-model:current-page="pageNo" v-model:page-size="pageSize" :page-sizes="[10, 20, 30, 40]"
      :backgroud="true" layout="prev, pager, next, jumper,->, total, sizes" :total="total" @current-change="getHasSku"
      @size-change="handler" />
      <!--抽屉组件-->
      <el-drawer v-model="drawer">
        ...
        <template #default>
          ...
          <el-row style="margin: 10px 0px;">
            ...
            <el-col :span="18">
              <el-tag type="danger" style="margin: 5px 5px;" v-for="item in skuInfo.skuSaleAttrValueList" :key="item.id">{{ item.saleAttrValueName }}</el-tag>
            </el-col>
          </el-row>
          <el-row style="margin: 10px 0px;">
