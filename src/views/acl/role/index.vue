<template>
  ...
  <el-card style="margin: 10px 0px">
    ...
    <el-pagination v-model:current-page="pageNo" v-model:page-size="pageSize" :page-sizes="[10, 20, 30, 40]"
      :backgroud="true" layout="prev, pager, next, jumper,->, total, sizes" :total="total" @current-change="getHasRole"
...
import { reqAllRoleList, reqAddOrUpdateRole, reqAllMenuList, reqSetPersmission,reqRemoveRole } from '@/api/acl/role'
import type { Records, RoleResponseData, RoleData, MenuResponseData, MenuList } from '@/api/acl/role/type'
